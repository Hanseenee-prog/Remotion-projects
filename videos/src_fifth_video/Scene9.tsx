...
export const Scene9: React.FC = () => {
  ...
  const teaserBlur = interpolate(teaserSpring, [0, 1], [10, 0]);
  const teaserY = interpolate(teaserSpring, [0, 1], [10, 0]) + interpolate(frame, [TEASER_OUT, TEASER_OUT + 10], [0, -40]);
  ...
  return (
    <AbsoluteFill style={{ background: "transparent", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: FONTS.mono, fontSize: 32, color: COLORS.accentC, fontWeight: 700, letterSpacing: 2, marginBottom: 20 }}>
          UP NEXT
        </div>
