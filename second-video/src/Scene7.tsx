...
//   34–60  : Button floats UP and scales (celebration)
...
export const Scene7: React.FC = () => {
  ...
  // ══ BUTTON FLOAT UP after click (frame 34+) ═══════════════════════════════════
  ...
  const btnFloatY     = frame >= 34 ? interpolate(btnFloatSpring, [0, 1], [0, -68]) : 0;
  ...
  // easeOutBack gives the satisfying scale overshoot pop
  ...
  return (
    <AbsoluteFill style={{
      ...
      <div style={{
        ...
        {/* CARD — exact Scene 1 markup, marginTop: 120, scale+opacity only */}
        {cardVisible && (
          <div style={{
            background: "#0D1117",
            ...
            padding: "40px 48px",
            borderRadius: 24,
            marginTop: 120,            // exact Scene 1 value
            width: 620,
            boxShadow: "0 40px 80px rgba(0,0,0,0.6)",
            color: "#E6EDF3",
            fontFamily: "system-ui, -apple-system, sans-serif",
            // Scale + opacity ONLY — no translateY
            opacity: cardOpacity,
      ...
      {/* ════ "CHECK CAPTION FOR MORE DETAILS." (frames 165–210) ═════════════════ */}
      {frame >= 165 && (
        <div style={{
          position: "absolute",
          top: "50%",
